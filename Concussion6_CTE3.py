...
file_run1 = os.path.join(base_dir, "data", "CTE_2.3.counts.tsv")
file_run2 = os.path.join(base_dir, "data", "CTE_2.4.counts.tsv")
file_run3 = os.path.join(base_dir, "data", "CTE_2.5.counts.tsv")
file_run4 = os.path.join(base_dir, "data", "CTE_3.3.counts.tsv")
file_run5 = os.path.join(base_dir, "data", "CTE_3.4.counts.tsv")
file_run6 = os.path.join(base_dir, "data", "CTE_3.5.counts.tsv")
...
control_5 = os.path.join(base_dir, "combined_runs", "combined_runs_CTES3.tsv")
