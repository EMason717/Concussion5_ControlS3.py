...
file_run1 = os.path.join(base_dir, "data", "Control_1.1.counts.tsv")
file_run2 = os.path.join(base_dir, "data", "Control_1.2.counts.tsv")
file_run3 = os.path.join(base_dir, "data", "Control_1.3.counts.tsv")
file_run4 = os.path.join(base_dir, "data", "Control_3.1.counts.tsv")
file_run5 = os.path.join(base_dir, "data", "Control_3.2.counts.tsv")
file_run6 = os.path.join(base_dir, "data", "Control_3.3.counts.tsv")
...
control_5 = os.path.join(base_dir, "combined_runs", "combined_runs_ControlS6.tsv")
