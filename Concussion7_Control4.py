...
file_run1 = os.path.join(base_dir, "data", "Control_4.4.counts.tsv")
file_run2 = os.path.join(base_dir, "data", "Control_4.5.counts.tsv")
file_run3 = os.path.join(base_dir, "data", "Control_7.4.counts.tsv")
file_run4 = os.path.join(base_dir, "data", "Control_7.5.counts.tsv")
file_run5 = os.path.join(base_dir, "data", "Control_7.6.counts.tsv")
...
df_combined = df_run1.add(df_run2, fill_value=0).add(df_run3, fill_value=0).add(df_run4, fill_value=0).add(df_run5, fill_value=0)
# Bring back 'barcode' back as normal column instead of the index:
df_combined.reset_index(inplace=True)
# Save the combined results to a new TSV file
control_5 = os.path.join(base_dir, "combined_runs", "combined_runs_ControlS4.tsv")
