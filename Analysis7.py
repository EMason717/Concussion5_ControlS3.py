...
def main():
    ...
    control_path = os.path.join(base_dir, 'LoggedControlS7.tsv')
    cte_path = os.path.join(base_dir, 'LoggedCTES7.tsv')
    ...
    result_path = os.path.join(output_dir, 'analysisS7.tsv')
