...
def main():
    ...
    control_path = os.path.join(base_dir, 'LoggedControlS2.tsv')
    cte_path = os.path.join(base_dir, 'LoggedCTES2.tsv')
    ...
    result_path = os.path.join(output_dir, 'analysisS2.tsv')
