...
file_run1 = os.path.join(base_dir, "data", "Control_2.1.counts.tsv")
file_run2 = os.path.join(base_dir, "data", "Control_2.2.counts.tsv")
file_run3 = os.path.join(base_dir, "data", "Control_2.3.counts.tsv")
file_run4 = os.path.join(base_dir, "data", "Control_8.1.counts.tsv")
file_run5 = os.path.join(base_dir, "data", "Control_8.2.counts.tsv")
file_run6 = os.path.join(base_dir, "data", "Control_8.3.counts.tsv")
...
df_combined = df_run1.add(df_run2, fill_value=0).add(df_run3, fill_value=0).add(df_run4, fill_value=0).add(df_run5, fill_value=0).add(df_run6, fill_value=0)
# Bring back 'barcode' back as normal column instead of the index:
df_combined.reset_index(inplace=True)
# Save the combined results to a new TSV file
control_5 = os.path.join(base_dir, "combined_runs", "combined_runs_ControlS5.tsv")
