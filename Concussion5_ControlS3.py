...
file_run1 = os.path.join(base_dir, "data", "Control_5.4.counts.tsv")
file_run2 = os.path.join(base_dir, "data", "Control_5.5.counts.tsv")
file_run3 = os.path.join(base_dir, "data", "Control_5.6.counts.tsv")
file_run4 = os.path.join(base_dir, "data", "Control_6.4.counts.tsv")
file_run5 = os.path.join(base_dir, "data", "Control_6.5.counts.tsv")
file_run6 = os.path.join(base_dir, "data", "Control_6.6.counts.tsv")
...
control_5 = os.path.join(base_dir, "combined_runs", "combined_runs_ControlS3.tsv")
