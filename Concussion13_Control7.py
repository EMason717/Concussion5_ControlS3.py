...
file_run1 = os.path.join(base_dir, "data", "Control_5.7.counts.tsv")
file_run2 = os.path.join(base_dir, "data", "Control_5.8.counts.tsv")
file_run3 = os.path.join(base_dir, "data", "Control_5.9.counts.tsv")
file_run4 = os.path.join(base_dir, "data", "Control_7.7.counts.tsv")
file_run5 = os.path.join(base_dir, "data", "Control_7.8.counts.tsv")
file_run6 = os.path.join(base_dir, "data", "Control_7.9.counts.tsv")
...
control_5 = os.path.join(base_dir, "combined_runs", "combined_runs_ControlS7.tsv")
