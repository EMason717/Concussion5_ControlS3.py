...
def main():
    ...
    control_path = os.path.join(base_dir, 'LoggedControlS6.tsv')
    cte_path = os.path.join(base_dir, 'LoggedCTES6.tsv')
    ...
    result_path = os.path.join(output_dir, 'analysisS6.tsv')
