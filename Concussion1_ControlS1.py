...
file_run1 = os.path.join(base_dir, "data", "Control_5.1.counts.tsv")
file_run2 = os.path.join(base_dir, "data", "Control_5.2.counts.tsv")
file_run3 = os.path.join(base_dir, "data", "Control_5.3.counts.tsv")
...
control_5 = os.path.join(base_dir, "combined_runs", "combined_runs_ControlS1.tsv")
