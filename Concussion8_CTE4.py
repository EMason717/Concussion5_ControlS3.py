...
file_run1 = os.path.join(base_dir, "data", "CTE_1.4.counts.tsv")
file_run2 = os.path.join(base_dir, "data", "CTE_1.5.counts.tsv")
file_run3 = os.path.join(base_dir, "data", "CTE_1.6.counts.tsv")
file_run4 = os.path.join(base_dir, "data", "CTE_4.4.counts.tsv")
file_run5 = os.path.join(base_dir, "data", "CTE_4.5.counts.tsv")
file_run6 = os.path.join(base_dir, "data", "CTE_4.6.counts.tsv")
...
control_5 = os.path.join(base_dir, "combined_runs", "Combined_runs_CTES4.tsv")
