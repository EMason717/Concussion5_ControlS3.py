...
def main():
    ...
    control_path = os.path.join(base_dir, 'LoggedControlS3.tsv')
    cte_path = os.path.join(base_dir, 'LoggedCTES3.tsv')
    ...
    result_path = os.path.join(output_dir, 'analysisS3.tsv')
