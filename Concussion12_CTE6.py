...
file_run1 = os.path.join(base_dir, "data", "CTE_7.1.counts.tsv")
file_run2 = os.path.join(base_dir, "data", "CTE_7.2.counts.tsv")
file_run3 = os.path.join(base_dir, "data", "CTE_7.3.counts.tsv")
file_run4 = os.path.join(base_dir, "data", "CTE_8.1.counts.tsv")
file_run5 = os.path.join(base_dir, "data", "CTE_8.2.counts.tsv")
file_run6 = os.path.join(base_dir, "data", "CTE_8.3.counts.tsv")
...
control_5 = os.path.join(base_dir, "combined_runs", "Combined_runs_CTES6.tsv")
