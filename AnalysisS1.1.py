...
def main():
    ...
    control_path = os.path.join(base_dir, 'LoggedControlS1.1.tsv')
    cte_path = os.path.join(base_dir, 'LoggedCTES1.1.tsv')
    ...
    result_path = os.path.join(output_dir, 'analysisS1.tsv')
