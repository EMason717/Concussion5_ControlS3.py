...
file_run1 = os.path.join(base_dir, "data", "CTE_5.1.counts.tsv")
file_run2 = os.path.join(base_dir, "data", "CTE_5.2.counts.tsv")
file_run3 = os.path.join(base_dir, "data", "CTE_5.3.counts.tsv")
file_run4 = os.path.join(base_dir, "data", "CTE_6.1.counts.tsv")
file_run5 = os.path.join(base_dir, "data", "CTE_6.2.counts.tsv")
file_run6 = os.path.join(base_dir, "data", "CTE_6.3.counts.tsv")
...
control_5 = os.path.join(base_dir, "combined_runs", "Combined_runs_CTES5.tsv")
