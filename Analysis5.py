...
def main():
    ...
    control_path = os.path.join(base_dir, 'LoggedControlS5.tsv')
    cte_path = os.path.join(base_dir, 'LoggedCTES5.tsv')
    ...
    result_path = os.path.join(output_dir, 'analysisS5.tsv')
